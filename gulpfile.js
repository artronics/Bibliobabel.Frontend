...
var paths = {
    ...
    distDev: '../Bibliobabel.Web/wwwroot/development',
    distProd: '../Bibliobabel.Web/wwwroot/production',
    distScriptsProd: './Bibliobabel.Web/wwwroot/production/scripts',
...
var pipes = {};
//pipes.getCdnUrls = function(){
//    var cdns = [
//        {
//            file: 'bower_component/angular/angular.js',
//            package: 'angular',
//            test: 'window.angular',
...
pipes.builtVendorScriptsDev = function () {
    return gulp.src(bowerFiles())
        .pipe(gulp.dest('../Bibliobabel.Web/wwwroot/development/bower_components'));
};
